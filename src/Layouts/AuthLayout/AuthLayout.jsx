...
const AuthLayout = () => {
  return (
    <div className="min-h-screen  mx-auto px-4 md:px-10 lg:px-20 dark:bg-gray-900">
        <div className="p-6">
        <Pothik />
        <div className="hidden"><DarkMood/></div>
        </div>
