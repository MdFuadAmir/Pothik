...
const ManageOrders = () => {
  ...
  return (
    <div>
      <h2 className="text-2xl font-bold text-emerald-400">Manage Orders</h2>
      <p className="text-gray-300 text-sm mb-4">
        Here you can see which customers ordered your products.
      </p>

      <div className="overflow-x-auto  bg-gray-900/80 rounded p-4">
                  ...
                  <tr key={item._id} className="text-gray-300">
                    ...
                    <td className="flex gap-2">
                      <button
                        ...
                        className="px-2 py-1 rounded bg-emerald-200 text-xs"
                      >
                      ...
                      <button
                        ...
                        className={`px-3 py-1 text-xs text-black rounded ${
                          item.status === "delivered"
                            ? "bg-green-300"
                            : item.status === "cancelled"
                              ? "bg-red-300"
        ...
        {selectedItem && (
          <div className="fixed inset-0 flex items-center justify-center z-50">
            <div className="bg-gray-900 rounded-lg shadow-xl p-6 w-[90%] max-w-lg relative overflow-y-auto max-h-[90vh]">
              <button
                onClick={() => setSelectedItem(null)}
                className="absolute top-3 right-3 text-gray-300 hover:text-gray-400 text-xl"
              >
                ✖
              </button>

              <h2 className="text-2xl font-bold mb-4 text-emerald-400">Order Details</h2>
              ...
              <div className="space-y-2 text-sm text-gray-300">
                ...
                <hr />
                <p className="text-lg font-bold pl-4 text-emerald-500">Buyer info</p>
                <p>
                ...
                <p>
                  <b>Full Address:</b>{" "}
                  {selectedItem.order.buyerInfo.fullAddress}
                </p>

                <hr />
                <p className="text-lg font-bold pl-4 text-emerald-500">Product Details</p>
                <p>
